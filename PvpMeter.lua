...
function PvpMeter.prepareQuickButton()
	...
	PvpMeter.button:ClearAnchors()
    PvpMeter.button:SetAnchor(TOPLEFT, ZO_ChatWindowOptions, TOPRIGHT, taba, 0)
	...
	--PvpMeter.button:ClearAnchors()
    PvpMeter.label_home:SetAnchor(TOPLEFT, ZO_ChatWindowOptions, TOPRIGHT, tabb , 4)
